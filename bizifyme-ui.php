...
<table class="form-table"><tr valign="top"><th scope="row"><?php _e('Auto import objects', 'bizifyme'); ?></th><td>
	...
	<label id="device-mobile"><input type="radio" name="device" value="mobile" <?php echo($options['settings']['device'] === 'mobile' || $options['settings']['device'] === '' ? 'checked="checked"' : ''); ?> /> <?php _e('The Bizfy.me app', 'bizifyme'); ?> (<a href="https://itunes.apple.com/app/bizify.me/id635602512" target="_blank">iPhone & iPad</a> / <a href="https://play.google.com/store/apps/details?id=me.bizify.application" target="_blank">Android</a> / <a href="https://www.microsoft.com/en-us/store/apps/bizifyme/9wzdncrfjqrk" target="_blank">Windows Phone</a>)</label>
	<br />
